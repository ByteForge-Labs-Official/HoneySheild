...
import { Activity, Bell, Hexagon, LayoutDashboard, Map, PieChart, Settings, Shield } from 'lucide-react';
    ...
    <header className="sticky top-0 z-40 border-b border-[#1F2A44]/80 bg-[#0B0F19]/80 backdrop-blur-xl">
      <div className="container flex h-16 items-center gap-6">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 rounded-full border border-[#1F2A44] bg-[#0F1626]/80 py-1 pl-1 pr-3">
            ...
            <span className="hidden text-xs font-medium text-[#E6F1FF] md:inline">jane@honeyshield</span>
          </div>
        </div>
      </div>
    </header>
